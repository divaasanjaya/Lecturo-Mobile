...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2025 at 04:36 PM
...
INSERT INTO `course` (`kodeMatkul`, `nama`, `kodeKelas`, `sks`, `dosenPengampu`) VALUES
('CAK3BAB3', 'PEMROGRAMAN BERORIENTASI OBJEK', 'IF-46-06', 4, 'DSW'),
('CDK2AAB4', 'STRUKTUR DATA', 'DS-47-02', 4, 'AFA'),
('CII1D3', 'KALKULUS', 'IF-48-04', 3, 'DSW'),
('CII2K2', 'STRATEGI ALGORITMA', 'IF-47-06', 3, 'DSW'),
('CAK3BAB3', 'PEMROGRAMAN BERORIENTASI OBJEK', 'IF-46-07', 4, 'AFA'),
('CAK3BAB5', 'STATISTIKA', 'IF-47-08', 2, 'DSW');
...
ALTER TABLE `course_mahasiswa`
  ADD CONSTRAINT `course_mahasiswa_ibfk_1` FOREIGN KEY (`kodeMatkul`) REFERENCES `course` (`kodeMatkul`) ON DELETE CASCADE,
  ADD CONSTRAINT `course_mahasiswa_ibfk_2` FOREIGN KEY (`NIM`) REFERENCES `mahasiswa` (`NIM`) ON DELETE CASCADE;
